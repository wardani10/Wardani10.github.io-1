...
window, addEventListener("load", () => {
  let play = setTimeout(playLoader, 2500);
})
...
const nomorWa = "6287823885211" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `Namamu yang sejuk seperti "christmas" dan Lina yang artinya "lembut" menjadi seorang wanita yang aku kagumi. Terima kasih banyak karena udah mau jadi temen aku yang baik :)`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    let txt = `${result.value.login} its a beautiful name.  ${pesan}`;
